...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀  
 ...
 function getArtistByIndex(someArray,artistIndex) {
  return `the artist at index ${someArray[artistIndex].id} is ${someArray[artistIndex].name}`;
}  
...
function get20s(someArray){
  ...
  {
    let born = someArray[i].years.substr(0,4);
    let died = someArray[i].years.substr(6);
...
function removeArtist(someArray,artistIndex){
   someArray.pop(artistIndex);
...
function addArtist(someArray){
    const obj =
    {
      ...
      bio: "I want to become a software engineer."
    }
    someArray.push(obj);
    return someArray;
  }
